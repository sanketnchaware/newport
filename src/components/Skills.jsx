            ...
            <Col lg={6} xs={12}>
              ...
              <Card className="skill-nbcard">
                <Card.Body>
                  ...
                  <Card.Text>
                    HTML, CSS, SASS, Tailwind CSS, JavaScript, ReactJs,
                    Redux-Toolkit.
                  </Card.Text>
                </Card.Body>
              </Card>
              <Card className="skill-nbcard">
                <Card.Body>
                  ...
                  <Card.Text>
                    ExpressJs, AdonisJs, NodeJS, MongoDB, Mysql{" "}
                  </Card.Text>
                </Card.Body>
              </Card>
              <Card className="skill-nbcard">
                <Card.Body>
                  ...
                  <Card.Text>
                    Git & Github, PostMan, MongoDb Atlas, Frontend Testing with
                    Cypress.
                  </Card.Text>
                </Card.Body>
              </Card>
              <Card className="skill-nbcard">
                <Card.Body>
                  ...
                  <Card.Text>Video Editing, Learning and Creating</Card.Text>
                </Card.Body>
              </Card>
            </Col>
          </Row>
